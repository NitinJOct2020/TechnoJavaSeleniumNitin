...
public class CreateAccountPage extends PredefinedActions{
	...
	public void enterCreateAccountDetails() {
		...
		wait.until(ExpectedConditions.visibilityOfElementLocated(By.id("customer_firstname"))).sendKeys("Nitin");
		System.out.println("Enter First Name");

		wait.until(ExpectedConditions.visibilityOfElementLocated(By.id("customer_lastname"))).sendKeys("jain");
